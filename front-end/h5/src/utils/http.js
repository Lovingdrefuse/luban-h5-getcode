...
export class AxiosWrapper {
  ...
  constructor ({ name = 'default', loading_name, responseType = 'json', headers={
    Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaXNBZG1pbiI6dHJ1ZSwiaWF0IjoxNjExMDU2NjYxLCJleHAiOjE2MTM2NDg2NjF9.fKsMl2JX72lIFsuzDwY2FFqk8lbxVPzeXYhP0fK0pMU'
  }, dispatch, commit, router, successMsg, failMsg, successCallback, failCallback, customRequest }) {
    this.name = name
    // eslint-disable-next-line camelcase
