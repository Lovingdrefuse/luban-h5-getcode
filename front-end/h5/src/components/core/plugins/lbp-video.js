...
export default {
  ...
  render (h) {
    ...
    return (
      <div class="lbc-video" width="100%" height="100%" style={style}>
        {
          this.useIframe
            ? <div ref="iframeWrapper"><img src={playIcon} width="100%" height="100%" /></div>
            : <video playsinline="true" webkit-playsinline="" autoplay = "true" muted="true" width="100%" height="100%" poster={playIcon} ref="videoTag" >
